...
public interface EmpresaServiceOut { ///Infra con un adaptador lo implementa a ServiceOut  ///esta interactua con nuestra BD base de datos

    EmpresaDTO crearEmpresaOut(RequestEmpresa requestEmpresa);// aqui trabajo con DTO y recibo parametros
